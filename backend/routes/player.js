...
router.get('/public/:tournamentId', async (req, res) => {
    try {
        ...
        const tournament = await Tournament.findById(tournamentId).select('name logoUrl isRegistrationOpen organizer');
...
// ==========================================
// 🔒 PRIVATE ROUTES (सिक्योरिटी गार्ड) 🔒
// ==========================================
